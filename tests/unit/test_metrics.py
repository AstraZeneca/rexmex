...
class TestClassificationMetrics(unittest.TestCase):
    ...
    def test_discovery_omission(self):
        assert false_omission_rate(self.y_true, self.y_score) == (1 - negative_predictive_value(self.y_true, self.y_score))
        assert false_discovery_rate(self.y_true, self.y_score) == (1 - positive_predictive_value(self.y_true, self.y_score))
