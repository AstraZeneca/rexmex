...
class TestMetricAggregation(unittest.TestCase):
    ...
    def test_classification(self):
        ...
        performance_metrics = score_card.generate_report(self.scores, groupping=["source_group"])
        assert performance_metrics.shape == (5, 11)

        performance_metrics = score_card.generate_report(self.scores, groupping=["source_group", "target_group"])
